      ...
      <form role="form" method="post" action="pages/dokter/tambah_dokter_proses.php">
            ...
            <div class="box-body table-responsive">
              <table id="dokter" class="table table-bordered table-hover">
                ...
                include "conf/conn.php";
                $no=0;
                $query=mysqli_query($conn,"SELECT dokter.*, poli.nama_poli FROM dokter JOIN poli ON dokter.id_poli = poli.id ORDER BY id DESC");
                //echo $query;
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="pages/dokter/hapus_dokter.php?id=<?=$row['id'];?>" class="btn btn-danger" role="button" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i>Hapus</a>
                  </td>
                </tr>
