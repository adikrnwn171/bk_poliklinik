        ...
        <div class="box-header">
            ...
            <div class="box-body table-responsive">
              <table id="jadwal_periksa" class="table table-bordered table-hover">
                ...
                $no=0;
                $query=mysqli_query($conn,"SELECT jadwal_periksa.*,dokter.id as id_dok,dokter.nama FROM jadwal_periksa JOIN dokter ON jadwal_periksa.id_dokter = dokter.id WHERE dokter.id = $id ORDER BY jadwal_periksa.id DESC");
                //echo $query;
