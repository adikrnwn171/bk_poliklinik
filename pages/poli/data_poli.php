...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form role="form" method="post" action="pages/poli/tambah_poli_proses.php">
              <div class="box-body">
            ...
            <div class="box-body table-responsive">
              <table id="poli" class="table table-bordered table-hover">
                ...
                $no=0;
                $query=mysqli_query($conn,"SELECT * FROM poli ORDER BY id DESC");
                //echo $query;
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="pages/poli/hapus_poli.php?id=<?=$row['id'];?>" class="btn btn-danger" role="button" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i>Hapus</a>
                  </td>
                </tr>
